...
def get_scatter_slider_chart(entered_site, payload_slider):
    if entered_site == 'ALL':
        fig = px.scatter(
                spacex_df[spacex_df['Payload Mass (kg)'].between(payload_slider[0], payload_slider[1])], 
                x = "Payload Mass (kg)", 
                y = "class", 
                color = "Booster Version Category", 
                hover_data = ['Launch Site'], 
                title = 'Correlation Between Payload Mass (Kg) and Success Payload for All Sites')
    else:
        ...
        fig = px.scatter(df[df['Payload Mass (kg)'].between(payload_slider[0], payload_slider[1])], 
                ...
                color = "Booster Version Category", 
                hover_data = ['Launch Site'], 
                title = 'Correlation Between Payload Mass (Kg) and Success Payload for Site {}'.format(entered_site))
    return fig
